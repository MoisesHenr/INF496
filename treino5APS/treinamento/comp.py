...
def compSimTr(est_ac, numEp, num, vRec, indR, vConst, indC):
	...
	tempMedioSim = {'AP0':[0, 0], 'AP1':[0, 0], 'AP2':[0, 0], 'AP3':[0, 0], 'AP4':[0, 0], 'AP5':[0, 0]} # estrutura para armazenar qual o tempo médio de cada AP --- primeiro elemento armazena o tempo total e o segundo armazena quantos intervalos ouveram
	tempMedioTr = {'AP0':[0, 0], 'AP1':[0, 0], 'AP2':[0, 0], 'AP3':[0, 0], 'AP4':[0, 0], 'AP5':[0, 0]} # estrutura para armazenar qual o tempo médio de cada AP --- primeiro elemento armazena o tempo total e o segundo armazena quantos intervalos ouveram
