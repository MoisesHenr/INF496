...
def plotComp(est_ac, numRota):
	...
	leg = {'AP0':'white', 'AP1':'pink', 'AP2':'red', 'AP3':'green', 'AP4':'orange', 'AP5':'blue'}
	...
	# resultado
	#plt.show()
	plt.savefig('comparaçõesGraficosRotas/compRota_' + str(numRota) + '.png')
...
for i in range(5):
	qValue = open("comparaçõesQvalue/qValue_999_R_" + str(i) + "_C_0.txt", "r")
	...
	rotas = random.sample(range(0,10000), 10)
