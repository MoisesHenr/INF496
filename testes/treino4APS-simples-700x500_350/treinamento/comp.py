...
def compSimTr_old(est_ac, numEp, num, vRec, indR, vConst, indC):
	...
	tempMedioSim = {'AP0':[0, 0], 'AP1':[0, 0], 'AP2':[0, 0], 'AP3':[0, 0], 'AP4':[0, 0]} # estrutura para armazenar qual o tempo médio de cada AP --- primeiro elemento armazena o tempo total e o segundo armazena quantos intervalos ouveram
	tempMedioTr = {'AP0':[0, 0], 'AP1':[0, 0], 'AP2':[0, 0], 'AP3':[0, 0], 'AP4':[0, 0]} # estrutura para armazenar qual o tempo médio de cada AP --- primeiro elemento armazena o tempo total e o segundo armazena quantos intervalos ouveram
...
def compSimTr(est_ac, numEp, num, vRec, indR, vConst, indC):
	...
	tempMedioSim = {'AP0':[0, 0], 'AP1':[0, 0], 'AP2':[0, 0], 'AP3':[0, 0], 'AP4':[0, 0]} # estrutura para armazenar qual o tempo médio de cada AP --- primeiro elemento armazena o tempo total e o segundo armazena quantos intervalos houveram
	tempMedioTr = {'AP0':[0, 0], 'AP1':[0, 0], 'AP2':[0, 0], 'AP3':[0, 0], 'AP4':[0, 0]} # estrutura para armazenar qual o tempo médio de cada AP --- primeiro elemento armazena o tempo total e o segundo armazena quantos intervalos houveram
	...
	for keyComp in tempMedioSim: # chaves são iguais para ambos dicionários
		...
		aux = str(keyComp) + " --- [" + str(tempoConSim) + ", " + str(numInterSim) + "] --- [" + str(tempoConTr) + ", " + str(numInterTr) + "\n"
		comp.writelines(aux)
		aux = str(keyComp) + " --- " + str(tmSim) + " --- " + str(tmTr) + "] --- " + str(porcAPtm) + " --- " + str(porcAPni) + "\n"
		comp.writelines(aux)
